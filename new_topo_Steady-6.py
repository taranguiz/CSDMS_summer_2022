...
print(nrows)
print(ncols)
print(" I'm going to put more uplift and more diffusion")
...
# uplift
uplift_rate= 9 *1e-5
print ('uplift is: ' +str(uplift_rate))
...
#Weathering
expweath=ExponentialWeatherer(mg, soil_production__maximum_rate=1*1e-4, soil_production__decay_depth=Hstar)
...
ddtd=DepthDependentTaylorDiffuser(mg,slope_crit=Sc,
                                  ...
                                  if_unstable='warn')
#Flow Router
fr=PriorityFloodFlowRouter(mg, flow_metric='D8', suppress_out=True, runoff_rate=0.8)
#SPACE Large Scale
...
for i in range(iterations):
    ...
    if i%200 ==0:
        ...
        plt.show()
        plt.savefig('output_new_topo_ddd_6/topo_%s_yrs.png' % (int(i * dt)), dpi=300, facecolor='white')

mg.save('output_new_topo_ddd_6/finaltopo.asc')
