...
K_br= 5*1e-6 #bedrock erodibility
...
ddtd=DepthDependentTaylorDiffuser(mg,
...
for i in range(iterations):
    ...
    if i%200 ==0:
        ...
        plt.show()
        plt.savefig('output_new_topo_ddd_4/topo_%s_yrs.png' % (int(i * dt)), dpi=300, facecolor='white')

mg.save('output_new_topo_ddd_4/finaltopo.asc')
