...
#Weathering
expweath=ExponentialWeatherer(mg, soil_production__maximum_rate=uplift_rate, soil_production__decay_depth=Hstar)
...
for i in range(iterations):
    ...
    if i%200 ==0:
        ...
        plt.show()
        plt.savefig('output_new_topo_ddd_3/topo_%s_yrs.png' % (int(i * dt)), dpi=300, facecolor='white')

mg.save('output_new_topo_ddd_3/finaltopo.asc')
